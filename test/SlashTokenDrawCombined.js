...
xdescribe("SlashTokenDrawCombined", function () {
    async function completeDeployVrfAndSlashToken() {
        ...
        //Registry deploy
        const SlashTokenDrawRegistry = await ethers.getContractFactory("SlashTokenDrawRegistry");
    ...
    describe("Complete Set Up", function () {
        describe("CHAINLINK", function () {
            describe("ERC20", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for ERC20 on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                ...
                xdescribe("SlashTokenDrawChainlinkV1 functionality tests", function () {
                    it("Should revert with NVS on createNewErc20Draw if not called by the registry", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVS on distributeErc20Prizes if not called by the creator", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with AD on distributeErc20Prizes if already distributed", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVL on distributeErc20Prizes if winnerdIds length not match winnerAddresses length", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVTY on distributeErc20Prizes if its not registered as an ERC20 trade", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVR on distributeErc20Prizes if request not yet fullfilled", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVPRO on distributeErc20Prizes if not valid proofs", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with custom error on distributeErc20Prizes if proofs not match winners", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with custom error on distributeErc20Prizes if not active approvals", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with custom error on distributeErc20Prizes if not valid balance", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                ...
                xdescribe("SlashTokenDrawRegistry functionality tests", function () {
                    it("Should revert with CF on createNewErc20DrawChainlink if contract frozen", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with UD on createNewErc20DrawChainlink if caller is denylisted", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NIY on createNewErc20DrawChainlink if registry not initialised", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVW on createNewErc20DrawChainlink if not valid winners amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with DIU on createNewErc20DrawChainlink if drawId already exists", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    it("Should revert with NVP on createNewErc20DrawChainlink if not valid participants amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(0, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc20DrawChainlink(drawId, await token.getAddress(), root, 10, 0, amountPerUser, {value: serviceFee + baseFee})).revertedWith('NVP')
                    ...
                    it("Should revert with NVPR on createNewErc20DrawChainlink if not active Chainlink contract", async function (){
                        const {
                            entropy,
                            slashTokenDrawRegistry,
                            slashTokenPyth,
                    ...
                    it("Should revert with NVV on createNewErc20DrawChainlink if not correct value", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
            ...
            xdescribe("Native", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for Native on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 5 bundle and create 5 draws no cost for Native on Chainlink", async function () {
                         const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 10 bundle and create 10 draws no cost for Native on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 30 bundle and create 30 draws no cost for Native on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should create draws with premium cost for Native", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should gift draws to user and creat draws with 0 cost for Native", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                ...
                xdescribe("SlashTokenDrawRegistry functionality tests", function () {
                    ...
                    it("Should revert with NVP on createNewNativeDrawChainlink if not valid participants amount", async function (){
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(0, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewNativeDrawChainlink(drawId, root, 10, 0, amountPerUser, {value: serviceFee + baseFee})).revertedWith('NVP')
            ...
            xdescribe("ERC721", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for ERC721 on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 5 bundle and create 5 draws no cost for ERC721 on Chainlink", async function () {
                         const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 10 bundle and create 10 draws no cost for ERC721 on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 30 bundle and create 30 draws no cost for ERC721 on Chainlink", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should create draws with premium cost for ERC721", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should gift draws to user and creat draws with 0 cost for ERC721", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
        ...
        xdescribe("PYTH", function () {
            describe("ERC20", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 100 times create merkle tree create draw and elect x winners with up to 10000 participants for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 1000 times create merkle tree create draw and elect x winners with up to 1000 participants for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 5 bundle and create 5 draws no cost for ERC20 on Pyth", async function () {
                         const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        for(let cycle = 0; cycle < 6; cycle++) {
                            ...
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            if (cycle <5) {
                                await slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: serviceFee})
                                await slashTokenPyth.revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)
                                const vrfResp = await slashTokenDrawRegistry.getRequestResponse(drawId)
                                const winners = []
                                const dict = Object.fromEntries(Array.from({length: Number(totalParticipants)}, (_, i) => [BigInt(i + 1), 0]));
                                ...
                                await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: serviceFee})).revertedWith('NVV')
                            }
                        }
                    }).timeout(10000000000000000000000000000000);
                    xit("Should buy a 10 bundle and create 10 draws no cost for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 30 bundle and create 30 draws no cost for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should create draws with premium cost for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should gift draws to user and creat draws with 0 cost for ERC20 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                ...
                xdescribe("SlashTokenDrawPythV1 functionality tests", function () {
                    it("Should revert with NVS on createNewErc20Draw if not called by the registry", async function (){
                        const {
                            vrf,
                            entropy,
                        ...
                        let amountPerUser = getRandomInt(100000000, 5000000000000000000000);
                        const drawId = web3.utils.randomHex(32)
                        await expect(slashTokenPyth.createNewErc20Draw(drawId, owner.address, await token.getAddress(), drawId, numOfWinners, totalParticipants, amountPerUser, drawId, 0)).revertedWith('NVS')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on distributeErc20Prizes if not called by the creator", async function (){
                        const {
                            vrf,
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.connect(otherAccount).distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith("NVS")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on revealRandomWordsAndElectWinners if not called by the creator", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            await slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: baseFee + serviceFee})
                            await expect(slashTokenPyth.connect(otherAccount).revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)).revertedWith("NVS")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with AE on revealRandomWordsAndElectWinners if already elected", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: baseFee + serviceFee})
                            await slashTokenPyth.revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)
                            await expect(slashTokenPyth.revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)).revertedWith('AE')
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with AD on distributeErc20Prizes if already distributed", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)
                            await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith("AD")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVL on distributeErc20Prizes if winnerdIds length not match winnerAddresses length", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses.slice(0,winnerAddresses.length - 2), winnerIds, proofFlags)).revertedWith('NVL')
                            await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds.slice(0, winnerIds.length - 2), proofFlags)).revertedWith("NVL")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVTY on distributeErc20Prizes if its not registered as an ERC20 trade", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith("NVTY")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVR on distributeErc20Prizes if request not yet fullfilled", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith("NVR")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPRO on distributeErc20Prizes if not valid proofs", async function (){
                        const {
                        ...
                        proofFlags[proofFlags.length - 1] = !proofFlags[proofFlags.length - 1]
                        await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith('NVPRO')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with custom error on distributeErc20Prizes if proofs not match winners", async function (){
                        const {
                            vrf,
                        ...
                        await expect(slashTokenPyth.distributeErc20Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWithCustomError(slashTokenChainlink, "TransferFromFailed()")
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with custom error on distributeErc20Prizes if not active approvals", async function (){
                        const {
                            vrf,
                ...
                xdescribe("SlashTokenDrawRegistry functionality tests", function () {
                    it("Should revert with CF on createNewErc20DrawPyth if contract frozen", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.freezeContract(1)
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('CF')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with UD on createNewErc20DrawPyth if caller is denylisted", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.addToDenylist([owner.address])
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('UD')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NIY on createNewErc20DrawPyth if registry not initialised", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const drawId = web3.utils.randomHex(32)
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, drawId, {value: baseFee})).revertedWith('NIY')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVW on createNewErc20DrawPyth if not valid winners amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 0, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('NVW')
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 101, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('NVW')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with DIU on createNewErc20DrawPyth if drawId already exists", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 10, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 10, totalParticipants, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('DIU')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVP on createNewErc20DrawPyth if not valid participants amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 10, 0, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('NVW')
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 10, 100001, amountPerUser, drawId, {value: serviceFee + baseFee})).revertedWith('NVP')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPR on createNewErc20DrawPyth if not active Chainlink contract", async function (){
                        const {
                            entropy,
                            slashTokenDrawRegistry,
                            slashTokenPyth,
                            owner,
                            otherAccount
                        } = await loadFixture(onlyChainlinkDeployVrfAndSlashToken);
                        let finalData;
                        await readAndParseFile(filePathFinal[0]).then((data) => {
                            finalData = data
                        })
                        ...
                        const drawId = web3.utils.randomHex(32)
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, 10, 200, amountPerUser, drawId, {value: baseFee})).revertedWith('NVPR')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVV on createNewErc20DrawPyth if not correct value", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc20DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, amountPerUser, drawId, {value: serviceFee })).revertedWith('NVV')
                    }).timeout(10000000000000000000000000000000);
                })
            })
            describe("Native", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 100 times create merkle tree create draw and elect x winners with up to 10000 participants for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 1000 times create merkle tree create draw and elect x winners with up to 1000 participants for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 5 bundle and create 5 draws no cost for Native on Pyth", async function () {
                         const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        for(let cycle = 0; cycle < 6; cycle++) {
                            ...
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            if (cycle <5) {
                                await slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: serviceFee})
                                await slashTokenPyth.revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)
                                const vrfResp = await slashTokenDrawRegistry.getRequestResponse(drawId)
                                const winners = []
                                const dict = Object.fromEntries(Array.from({length: Number(totalParticipants)}, (_, i) => [BigInt(i + 1), 0]));
                                ...
                                await slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser*numOfWinners})
                                for (let i = 0; i < numOfWinners; i++) {
                                    expect(await ethers.provider.getBalance(winnerAddresses[i])).to.equal(winningHistory[winnerAddresses[i]])
                                }
                            }else {
                                await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: serviceFee})).revertedWith('NVV')
                            }
                        }
                    }).timeout(10000000000000000000000000000000);
                    xit("Should buy a 10 bundle and create 10 draws no cost for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 30 bundle and create 30 draws no cost for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should create draws with premium cost for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should gift draws to user and creat draws with 0 cost for Native on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                ...
                xdescribe("SlashTokenDrawPyth1 functionality tests", function () {
                    it("Should revert with NVS on createNewNativeDraw if not called by the registry", async function (){
                        const {
                            vrf,
                            entropy,
                        ...
                        const root = tree.root
                        const drawId = web3.utils.randomHex(32)
                        await expect(slashTokenPyth.createNewNativeDraw(drawId, owner.address, root, numOfWinners, totalParticipants, amountPerUser, drawId, 0)).revertedWith('NVS')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on distributeNativePrizes if not called by the creator", async function (){
                        const {
                            vrf,
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.connect(otherAccount).distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags)).revertedWith("NVS")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on revealRandomWordsAndElectWinners if not called by the creator", async function (){
                        const {
                    ...
                    it("Should revert with AD on distributeNativePrizes if already distributed", async function (){
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser*numOfWinners})
                            await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser*numOfWinners})).revertedWith("AD")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVL on distributeNativePrizes if winnerdIds length not match winnerAddresses length", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses.slice(0,winnerAddresses.length - 2), winnerIds, proofFlags, {value: amountPerUser*numOfWinners})).revertedWith('NVL')
                            await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds.slice(0, winnerIds.length - 2), proofFlags, {value: amountPerUser*numOfWinners})).revertedWith("NVL")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVTY on distributeNativePrizes if its not registered as a Native trade", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: numOfWinners*amountPerUser})).revertedWith("NVTY")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVR on distributeNativePrizes if request not yet fullfilled", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: numOfWinners*amountPerUser})).revertedWith("NVR")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPRO on distributeNativePrizes if not valid proofs", async function (){
                        const {
                        ...
                        proofFlags[proofFlags.length - 1] = !proofFlags[proofFlags.length - 1]
                        await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser*numOfWinners})).revertedWith('NVPRO')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with custom error on distributeNativePrizes if proofs not match winners", async function (){
                        const {
                            vrf,
                        ...
                        await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser*numOfWinners})).revertedWithCustomError(slashTokenChainlink, "TransferFromFailed()")
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVV on distributeNativePrizes if not valid value sent", async function (){
                        const {
                            vrf,
                        ...
                        await expect(slashTokenPyth.distributeNativePrizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, {value: amountPerUser})).revertedWith( "NVV")
                    }).timeout(10000000000000000000000000000000);
                })
                xdescribe("SlashTokenDrawRegistry functionality tests", function () {
                    it("Should revert with CF on createNewNativeDrawChainlink if contract frozen", async function (){
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.freezeContract(1)
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: baseFee+serviceFee})).revertedWith('CF')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with UD on createNewNativeDrawChainlink if caller is denylisted", async function (){
                        const {
                            vrf,
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.addToDenylist([owner.address])
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('UD')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NIY on createNewNativeDrawChainlink if registry not initialised", async function (){
                        const {
                            vrf,
                        ...
                        const commitment = web3.utils.keccak256(userRandomNumber);
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, numOfWinners, totalParticipants, amountPerUser, commitment, {value: baseFee})).revertedWith('NIY')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVW on createNewNativeDrawChainlink if not valid winners amount", async function (){
                        const {
                            vrf,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 0, totalParticipants, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('NVW')
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 101, totalParticipants, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('NVW')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with DIU on createNewNativeDrawChainlink if drawId already exists", async function (){
                        const {
                            vrf,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 10, totalParticipants, amountPerUser, commitment, {value: serviceFee + baseFee})
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 10, totalParticipants, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('DIU')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVP on createNewNativeDrawChainlink if not valid participants amount", async function (){
                        const {
                            vrf,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 10, 0, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('NVP')
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 10, 100001, amountPerUser, commitment, {value: serviceFee + baseFee})).revertedWith('NVP')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPR on createNewNativeDrawChainlink if not active Pyth contract", async function (){
                        const {
                            entropy,
                            slashTokenDrawRegistry,
                            slashTokenPyth,
                        ...
                        const commitment = web3.utils.keccak256(userRandomNumber);
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewNativeDrawPyth(drawId, root, 10, 200, amountPerUser, commitment, {value: baseFee})).revertedWith('NVPR')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVV on createNewNativeDrawChainlink if not correct value", async function (){
                        const {
                            vrf,
            ...
            describe("ERC721", function () {
                describe("E2E Draw", function () {
                    it("Should run 10 times create merkle tree create draw and elect x winners with up to 100000 participants for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 100 times create merkle tree create draw and elect x winners with up to 10000 participants for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should run 1000 times create merkle tree create draw and elect x winners with up to 1000 participants for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 5 bundle and create 5 draws no cost for ERC721 on Pyth", async function () {
                         const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        for(let cycle = 0; cycle < 6; cycle++) {
                            ...
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            if (cycle <5) {
                                await slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, tokenIds, commitment, {value: serviceFee})
                                await slashTokenPyth.revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)
                                const vrfResp = await slashTokenDrawRegistry.getRequestResponse(drawId)
                                const winners = []
                                const dict = Object.fromEntries(Array.from({length: Number(totalParticipants)}, (_, i) => [BigInt(i + 1), 0]));
                                ...
                                await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, tokenIds, commitment, {value: serviceFee})).revertedWith('NVV')
                            }
                        }
                    }).timeout(10000000000000000000000000000000);
                    xit("Should buy a 10 bundle and create 10 draws no cost for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should buy a 30 bundle and create 30 draws no cost for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should create draws with premium cost for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                    ...
                    xit("Should gift draws to user and creat draws with 0 cost for ERC721 on Pyth", async function () {
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                ...
                xdescribe("SlashTokenDrawPyth functionality tests", function () {
                    it("Should revert with NVS on createNewErc721Draw if not called by the registry", async function (){
                        const {
                            vrf,
                            entropy,
                        ...
                        const root = tree.root
                        const drawId = web3.utils.randomHex(32)
                        await expect(slashTokenPyth.createNewErc721Draw(drawId, owner.address, await token.getAddress(), root, numOfWinners, totalParticipants, drawId, drawId, 0)).revertedWith('NVS')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on distributeErc721Prizes if not called by the creator", async function (){
                        const {
                            vrf,
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.connect(otherAccount).distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWith("NVS")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVS on revealRandomWordsAndElectWinners if not called by the creator", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            const baseFee = await slashTokenDrawRegistry.baseFee()
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            await slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, [0], commitment, {value: baseFee + serviceFee})
                            await expect(slashTokenPyth.connect(otherAccount).revealRandomWordsAndElectWinners(drawId, userRandomNumber, providerRandomNumber)).revertedWith("NVS")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with AE on revealRandomWordsAndElectWinners if already elected", async function (){
                    ...
                    it("Should revert with AD on distributeErc721Prizes if already distributed", async function (){
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)
                            await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWith("AD")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVL on distributeErc721Prizes if winnerdIds length not match winnerAddresses length", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses.slice(0,winnerAddresses.length - 2), winnerIds, proofFlags, tokenIds)).revertedWith('NVL')
                            await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds.slice(0, winnerIds.length - 2), proofFlags, tokenIds)).revertedWith("NVL")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVTY on distributeErc721Prizes if its not registered as an ERC721 trade", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, [0])).revertedWith("NVTY")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVR on distributeErc721Prizes if request not yet fullfilled", async function (){
                        const {
                        ...
                        for(let cycle = 0; cycle < 1; cycle++) {
                            ...
                            const baseFee = await slashTokenDrawRegistry.baseFee()
                            const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                            await slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, tokenIds, drawId, {value: baseFee + serviceFee})
                            const vrfResp = 519814141413414n
                            const winners = []
                            const dict = Object.fromEntries(Array.from({ length: Number(totalParticipants) }, (_, i) => [BigInt(i + 1), 0]));
                            for (let i =0; i<numOfWinners;i++){
                            ...
                            await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWith("NVR")
                        }
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPRO on distributeErc721Prizes if not valid proofs", async function (){
                        const {
                        ...
                        proofFlags[proofFlags.length - 1] = !proofFlags[proofFlags.length - 1]
                        await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWith('NVPRO')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with custom error on distributeErc721Prizes if proofs not match winners", async function (){
                        const {
                            vrf,
                        ...
                        await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWithCustomError(slashTokenChainlink, "TransferFromFailed()")
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with custom error on distributeErc721Prizes if not active approvals", async function (){
                        const {
                            vrf,
                    ...
                    it("Should revert with custom error on distributeErc721Prizes if not valid balance", async function (){
                        ...
                        await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWithCustomError(slashTokenPyth, "TransferFromFailed()")
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVT on distributeErc721Prizes if not valid token Ids", async function (){
                        const {
                            vrf,
                        ...
                        tokenIds.pop()
                        tokenIds.push(2345324)
                        await expect(slashTokenPyth.distributeErc721Prizes(drawId, proof, winnerAddresses, winnerIds, proofFlags, tokenIds)).revertedWith( "NVT")
                    }).timeout(10000000000000000000000000000000);
                })
                xdescribe("SlashTokenDrawRegistry functionality tests", function () {
                    it("Should revert with CF on createNewErc721DrawPyth if contract frozen", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.freezeContract(1)
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, [1], drawId, {value: serviceFee + baseFee})).revertedWith('CF')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with UD on createNewErc721DrawPyth if caller is denylisted", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.addToDenylist([owner.address])
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, [0], drawId, {value: serviceFee + baseFee})).revertedWith('UD')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NIY on createNewErc721DrawPyth if registry not initialised", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const drawId = web3.utils.randomHex(32)
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, [0], drawId, {value: baseFee})).revertedWith('NIY')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVW on createNewErc721DrawPyth if not valid winners amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 0, totalParticipants, tokenIds, drawId, {value: serviceFee + baseFee})).revertedWith('NVW')
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 101, totalParticipants, tokenIds, drawId,  {value: serviceFee + baseFee})).revertedWith('NVW')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with DIU on createNewErc721DrawPyth if drawId already exists", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 10, totalParticipants, tokenIds, drawId, {value: serviceFee + baseFee})
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 10, totalParticipants, tokenIds, drawId, {value: serviceFee + baseFee})).revertedWith('DIU')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVP on createNewErc721DrawPyth if not valid participants amount", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 10, 0, tokenIds, drawId, {value: serviceFee + baseFee})).revertedWith('NVP')
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 10, 100001, tokenIds, drawId, {value: serviceFee + baseFee})).revertedWith('NVP')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVPR on createNewErc721DrawPyth if not active Pyth contract", async function (){
                        const {
                            entropy,
                            slashTokenDrawRegistry,
                            slashTokenPyth,
                        ...
                        const drawId = web3.utils.randomHex(32)
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, 10, 200, tokenIds, drawId, {value: baseFee})).revertedWith('NVPR')
                    }).timeout(10000000000000000000000000000000);
                    it("Should revert with NVV on createNewErc721DrawPyth if not correct value", async function (){
                        const {
                            vrf,
                            entropy,
                            slashTokenDrawRegistry,
                        ...
                        const baseFee = await slashTokenDrawRegistry.baseFee()
                        const [serviceFee, statusCode] = await slashTokenDrawRegistry.calculateVRFCost(1, 40000000000n)
                        await expect(slashTokenDrawRegistry.createNewErc721DrawPyth(drawId, await token.getAddress(), root, numOfWinners, totalParticipants, tokenIds, drawId, {value: serviceFee })).revertedWith('NVV')
                    }).timeout(10000000000000000000000000000000);
                })
            })
        })
