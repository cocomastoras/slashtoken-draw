...
contract VRFCoordinatorV2_5Mock is IVRFCoordinatorV2Plus {
  ...
  function fulfillRandomWordsWithOverride(
    ...
    emit RandomWordsFulfilled(_requestId, _requestId, req.subId, payment, false, success, false);
  }
  ...
  function requestRandomWords(VRFV2PlusClient.RandomWordsRequest calldata req) external returns (uint256 requestId) {
    ...
    s_requests[requestId] = Request({subId: req.subId, callbackGasLimit: req.callbackGasLimit, numWords: req.numWords});
