...
/// @custom:version 1.0
/// @title SlashTokenDrawChainlinkV2
/// @notice SlashTokenDrawChainlinkV2 is a simple, yet powerful tool to airdrop tokens/NFTs or native currency to lottery winners using merkle trees and chainlink vrf.
contract SlashTokenDrawChainlinkV2 is ManagerActions, VRFConfig, TokenTransferer {
    ...
    **/
    function distributeErc20Prizes(bytes32 drawId_, bytes32[] memory proof, address[] memory winnerAddresses, uint256[] memory winnerIds, bool[] memory flags) external {
        ...
        _cacheAndPerformMultiERC20TransferCustom(token, winnerAddresses, winnerIds, drawIdToWinningAmount[drawId_], drawId_, slot);
    }
